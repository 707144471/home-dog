...
- (void)btnclick {
    PeopleIsChildCenter *vc = [[PeopleIsChildCenter alloc] init];
...
- (void)viewDidLoad {
    ...
    // 添加控制器
    peopleCenterViewController *leftVc = [[peopleCenterViewController alloc] init];
